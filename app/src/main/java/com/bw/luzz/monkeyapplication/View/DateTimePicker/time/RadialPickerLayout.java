...
package com.bw.luzz.monkeyapplication.View.DateTimePicker.time;
...
import com.bw.luzz.monkeyapplication.View.DateTimePicker.time.*;
import com.bw.luzz.monkeyapplication.View.DateTimePicker.time.AmPmCirclesView;
import com.bw.luzz.monkeyapplication.View.DateTimePicker.time.RadialTextsView;
...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    private static final int HOUR_INDEX = com.bw.luzz.monkeyapplication.View.DateTimePicker.time.TimePickerDialog.HOUR_INDEX;
    private static final int MINUTE_INDEX = com.bw.luzz.monkeyapplication.View.DateTimePicker.time.TimePickerDialog.MINUTE_INDEX;
    private static final int SECOND_INDEX = com.bw.luzz.monkeyapplication.View.DateTimePicker.time.TimePickerDialog.SECOND_INDEX;
    private static final int AM = com.bw.luzz.monkeyapplication.View.DateTimePicker.time.TimePickerDialog.AM;
    private static final int PM = com.bw.luzz.monkeyapplication.View.DateTimePicker.time.TimePickerDialog.PM;
    ...
    private com.bw.luzz.monkeyapplication.View.DateTimePicker.time.CircleView mCircleView;
    private com.bw.luzz.monkeyapplication.View.DateTimePicker.time.AmPmCirclesView mAmPmCirclesView;
    private com.bw.luzz.monkeyapplication.View.DateTimePicker.time.RadialTextsView mHourRadialTextsView;
    private com.bw.luzz.monkeyapplication.View.DateTimePicker.time.RadialTextsView mMinuteRadialTextsView;
    private com.bw.luzz.monkeyapplication.View.DateTimePicker.time.RadialTextsView mSecondRadialTextsView;
    ...
    public RadialPickerLayout(Context context, AttributeSet attrs) {
        ...
        mMinuteRadialTextsView = new com.bw.luzz.monkeyapplication.View.DateTimePicker.time.RadialTextsView(context);
        addView(mMinuteRadialTextsView);
        mSecondRadialTextsView = new com.bw.luzz.monkeyapplication.View.DateTimePicker.time.RadialTextsView(context);
    ...
    public void initialize(Context context, TimePickerDialog timePickerDialog,
        ...
        com.bw.luzz.monkeyapplication.View.DateTimePicker.time.RadialTextsView.SelectionValidator secondValidator = new com.bw.luzz.monkeyapplication.View.DateTimePicker.time.RadialTextsView.SelectionValidator() {
            @Override
        ...
        com.bw.luzz.monkeyapplication.View.DateTimePicker.time.RadialTextsView.SelectionValidator minuteValidator = new com.bw.luzz.monkeyapplication.View.DateTimePicker.time.RadialTextsView.SelectionValidator() {
            @Override
            public boolean isValidSelection(int selection) {
        ...
        com.bw.luzz.monkeyapplication.View.DateTimePicker.time.RadialTextsView.SelectionValidator hourValidator = new RadialTextsView.SelectionValidator() {
            @Override
            public boolean isValidSelection(int selection) {
