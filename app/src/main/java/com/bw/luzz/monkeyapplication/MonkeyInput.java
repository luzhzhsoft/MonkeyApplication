...
public class MonkeyInput {
     ...
     */
    public static void sendCommands(String[] args) {
        (new MonkeyInput()).run(args);
    }
     ...
     * @param mode
     */
    private static void refectInputEvent(InputEvent event,int mode){
        Class<InputManager> clzz=InputManager.class;
        InputManager inputManager=null;
        try {
            Method getInstance=clzz.getDeclaredMethod("getInstance",null);
