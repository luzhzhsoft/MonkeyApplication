package com.bw.luzz.monkeyapplication.View.material;
...
import com.bw.luzz.monkeyapplication.View.Utils;
...
public class Switch extends CustomView {
	...
	protected void onDraw(Canvas canvas) {
		...
		temp.drawCircle(getX() + ball.getWidth() / 2,
				getY() + ball.getHeight() / 2,
		...
		if (press) {
			...
			canvas.drawCircle(getX() + ball.getWidth() / 2,
					getHeight() / 2, getHeight() / 2, paint);
		}
		invalidate();
	 ...
	 * @return
	 */
	protected @ColorInt int makePressColor() {
	...
	private void placeBall() {
		setX(getHeight() / 2 - ball.getWidth() / 2);
		ball.xIni = getX();
